...
<div class="grid gap-6 md:grid-cols-[minmax(0,1.4fr)_minmax(0,1fr)]">
    <div class="glass-card rounded-2xl border border-white/10 bg-slate-900/60 p-6">
        ...
        <p class="text-sm text-slate-400 mb-4">
            Upload a file and the API will return its Base64 representation and metadata.
        </p>

        @include('tools.base64.partials._request_form', ['submitLabel' => 'Encode file'])
    </div>
    ...
    <div class="glass-card rounded-2xl border border-white/10 bg-slate-900/60 p-6">
        ...
        'emptyMessage' => 'Upload a file to see the Base64 payload and metadata returned by the API.',
        ])
    </div>
</div>
@endsection