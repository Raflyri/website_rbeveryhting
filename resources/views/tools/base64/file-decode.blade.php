...
<div class="glass-card rounded-2xl border border-white/10 bg-slate-900/60 p-6">
    ...
    <p class="text-sm text-slate-400 mb-4">
        Paste a Base64 string and desired filename. The API will decode it and this page will return a file download.
    </p>

    @include('tools.base64.partials._request_form', ['submitLabel' => 'Decode and download'])

    <p class="mt-4 text-xs text-slate-500">
        On success, you should see your browser start downloading the decoded file. If something goes wrong, an error
