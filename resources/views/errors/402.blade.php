...
<head>
    ...
    <title>402 Payment Required - RBeverything</title>
...
<body class="antialiased font-sans selection:bg-emerald-500 selection:text-white bg-slate-950 text-slate-100 flex flex-col min-h-screen">
    ...
    <main class="flex-1 flex items-center justify-center relative overflow-hidden pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="absolute bottom-1/4 left-1/4 w-72 h-72 bg-green-500/10 rounded-full blur-3xl pointer-events-none"></div>
        ...
        <div class="relative z-10 w-full max-w-2xl text-center">
            <div class="glass-card rounded-3xl p-8 sm:p-12 shadow-2xl overflow-hidden relative">
                ...
                <div class="flex justify-center mb-8 relative">
                    <div class="w-32 h-32 rounded-full bg-emerald-500/10 border border-emerald-500/20 flex flex-col items-center justify-center relative shadow-[0_0_30px_rgba(16,185,129,0.15)]">
                        <i data-feather="dollar-sign" class="w-12 h-12 text-emerald-400 opacity-80 absolute animate-pulse"></i>
                        <i data-feather="credit-card" class="w-16 h-16 text-emerald-500/30"></i>
                    </div>
                </div>

                <h1 class="text-7xl sm:text-9xl font-black tracking-tighter mb-4 select-none">
                    <span class="clip-text-gradient-emerald opacity-90">402</span>
                </h1>

                <h2 class="text-2xl sm:text-3xl font-bold text-white mb-4">Payment Required</h2>

                <p class="text-slate-400 text-sm sm:text-base max-w-md mx-auto mb-10 leading-relaxed">
                    This content or action requires payment or an active subscription. Please update your billing information.
                </p>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <a href="{{ url('/') }}" class="w-full sm:w-auto px-6 py-3 rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-medium transition-colors shadow-lg shadow-emerald-500/25 flex items-center justify-center gap-2">
