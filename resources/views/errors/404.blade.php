...
<head>
    ...
    <title>404 Not Found - RBeverything</title>
...
<body class="antialiased font-sans selection:bg-blue-500 selection:text-white bg-slate-950 text-slate-100 flex flex-col min-h-screen">
    ...
    <main class="flex-1 flex items-center justify-center relative overflow-hidden pt-24 pb-12 px-4 sm:px-6 lg:px-8">
        ...
        <div class="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-blue-600/20 rounded-full blur-[100px] pointer-events-none"></div>
        ...
        <div class="relative z-10 w-full max-w-2xl text-center">
            <div class="glass-card rounded-3xl p-8 sm:p-12 shadow-2xl overflow-hidden relative">
                ...
                <div class="flex justify-center mb-8 relative">
                    <div class="w-32 h-32 rounded-full bg-blue-500/10 border border-blue-500/20 flex flex-col items-center justify-center relative shadow-[0_0_30px_rgba(59,130,246,0.2)]">
                        <i data-feather="compass" class="w-12 h-12 text-blue-400 opacity-80 absolute animate-pulse"></i>
                        <i data-feather="slash" class="w-16 h-16 text-slate-600"></i>
                    </div>
                </div>

                <h1 class="text-7xl sm:text-9xl font-black tracking-tighter mb-4 select-none">
                    <span class="clip-text-gradient opacity-90">404</span>
                </h1>

                <h2 class="text-2xl sm:text-3xl font-bold text-white mb-4">Lost in cyberspace</h2>

                <p class="text-slate-400 text-sm sm:text-base max-w-md mx-auto mb-10 leading-relaxed">
                    Oops! We can't seem to find the page you're looking for. It might have been moved, deleted, or perhaps it never existed at all.
                </p>
                ...
                <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                    ...
                    <a href="{{ url('/') }}" class="w-full sm:w-auto px-6 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-medium transition-colors shadow-lg shadow-blue-500/25 flex items-center justify-center gap-2">
